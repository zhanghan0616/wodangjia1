...
public class User implements Serializable{
	...
	public User(int user_id, String user_phone, String user_password,
			String user_photo, String user_sickname, boolean user_gender,
		...
		this.user_sickname = user_sickname;
	...
	public User(String user_phone2, String user_password2, String user_photo2,
			String user_sickname2, boolean user_gender2, String user_school2,
	...
	public String getUser_sickname() {
		return user_sickname;
	}
	public void setUser_sickname(String user_sickname) {
		this.user_sickname = user_sickname;
	}
	...
	public String toString() {
		return "User [user_id=" + user_id + ", user_phone=" + user_phone
				...
				+ user_photo + ", user_sickname=" + user_sickname
